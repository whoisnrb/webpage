            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                    {stats.map((stat, index) => (
                        ...
                        >
                            <SpotlightCard
                                className="h-full border border-white/10 bg-white/[0.01] backdrop-blur-3xl rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-10 flex flex-col items-center text-center hover:border-primary/40 transition-all duration-700 hover:scale-[1.02] hover:shadow-[0_20px_50px_-10px_rgba(0,0,0,0.5)]"
                                spotlightColor={stat.color}
                            >
                                <div className="h-16 w-16 md:h-20 md:w-20 rounded-[1.2rem] md:rounded-[1.5rem] bg-white/[0.03] border border-white/10 flex items-center justify-center mb-6 md:mb-8 group-hover:bg-primary/10 group-hover:border-primary/50 group-hover:scale-110 transition-all duration-700">
