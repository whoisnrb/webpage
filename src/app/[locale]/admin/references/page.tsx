import { getReferences, deleteReference, ReferenceDTO } from "@/app/actions/reference"
...
function ReferenceTable({ references }: { references: ReferenceDTO[] }) {
    return (
        <Table>
            <TableHeader>
                <TableRow>
        ...
        <div className="space-y-6">
            ...
            <Tabs defaultValue="websites" className="space-y-4">
                ...
                <TabsContent value="websites" className="border rounded-lg bg-card">
                    <ReferenceTable references={websites} />
                </TabsContent>
