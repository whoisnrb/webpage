        ...
        <div className="min-h-screen bg-slate-950 flex items-center justify-center p-6 text-white">
            <div className="w-full max-w-md space-y-8 bg-slate-900 p-10 rounded-3xl border border-slate-800 shadow-xl">
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            <div className="flex justify-between mb-1">
                                ...
                                <Link href="/auth/reset" className="text-sm text-blue-500 hover:underline">Forgot?</Link>
                            </div>
                            <input
                                type="password"
                                required
                ...
                <div className="relative flex items-center justify-center">
                    <span className="absolute bg-slate-900 px-4 text-sm text-slate-500 uppercase">Or</span>
